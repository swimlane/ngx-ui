 ...
 */
const U = globalThis, ne = U.ShadowRoot && (U.ShadyCSS === void 0 || U.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, se = Symbol(), be = /* @__PURE__ */ new WeakMap();
let Se = class {
  constructor(e, t, i) {
...
}, fe = ne ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ze, defineProperty: Be, getOwnPropertyDescriptor: We, getOwnPropertyNames: Ge, getOwnPropertySymbols: Ie, getPrototypeOf: Xe } = Object, A = globalThis, he = A.trustedTypes, Je = he ? he.emptyScript : "", R = A.reactiveElementPolyfillSupport, H = (n, e) => n, T = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Je : null;
      break;
  ...
  return t;
} }, re = (n, e) => !ze(n, e), de = { attribute: !0, type: String, converter: T, reflect: !1, useDefault: !1, hasChanged: re };
...
let S = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(H("properties"))) {
      const t = this.properties, i = [...Ge(t), ...Ie(t)];
  ...
  _$ET(e, t) {
    ...
    if (o !== void 0 && i.reflect === !0) {
      const s = (((r = i.converter) == null ? void 0 : r.toAttribute) !== void 0 ? i.converter : T).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const c = i.getPropertyOptions(o), a = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((r = c.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? c.converter : T;
      this._$Em = o;
  ...
  requestUpdate(e, t, i, o = !1, r) {
    ...
    if (e !== void 0) {
      ...
      if (o === !1 && (r = this[e]), i ?? (i = c.getPropertyOptions(e)), !((i.hasChanged ?? re)(r, t) || i.useDefault && i.reflect && r === ((s = this._$Ej) == null ? void 0 : s.get(e)) && !this.hasAttribute(c._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[H("elementProperties")] = /* @__PURE__ */ new Map(), S[H("finalized")] = /* @__PURE__ */ new Map(), R == null || R({ ReactiveElement: S }), (A.reactiveElementVersions ?? (A.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Q = globalThis, ue = (n) => n, Z = Q.trustedTypes, me = Z ? Z.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, Fe = "$lit$", v = `lit$${Math.random().toFixed(9).slice(2)}$`, Ye = "?" + v, Ue = `<${Ye}>`, C = document, j = () => C.createComment(""), z = (n) => n === null || typeof n != "object" && typeof n != "function", ce = Array.isArray, Te = (n) => ce(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", V = `[ 	
\f\r]`, P = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, we = /-->/g, pe = />/g, D = RegExp(`>|${V}(?:([^\\s"'>=/]+)(${V}*=${V}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ge = /'/g, ye = /"/g, Oe = /^(?:script|style|textarea|title)$/i, Ze = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), d = Ze(1), Y = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), ve = /* @__PURE__ */ new WeakMap(), E = C.createTreeWalker(C, 129);
function Pe(n, e) {
...
const Le = (n, e) => {
  ...
  let o, r = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", s = P;
  for (let c = 0; c < t; c++) {
    const a = n[c];
    let l, f, b = -1, g = 0;
    for (; g < a.length && (s.lastIndex = g, f = s.exec(a), f !== null); ) g = s.lastIndex, s === P ? f[1] === "!--" ? s = we : f[1] !== void 0 ? s = pe : f[2] !== void 0 ? (Oe.test(f[2]) && (o = RegExp("</" + f[2], "g")), s = D) : f[3] !== void 0 && (s = D) : s === D ? f[0] === ">" ? (s = o ?? P, b = -1) : f[1] === void 0 ? b = -2 : (b = s.lastIndex - f[2].length, l = f[1], s = f[3] === void 0 ? D : f[3] === '"' ? ye : ge) : s === ye || s === ge ? s = D : s === we || s === pe ? s = P : (s = D, o = void 0);
    const y = s === D && n[c + 1].startsWith("/>") ? " " : "";
    r += s === P ? a + Ue : b >= 0 ? (i.push(l), a.slice(0, b) + Fe + a.slice(b) + v + y) : a + v + (b === -2 ? c : y);
  }
  return [Pe(n, r + (n[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class B {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let r = 0, s = 0;
    const c = e.length - 1, a = this.parts, [l, f] = Le(e, t);
    if (this.el = B.createElement(l, i), E.currentNode = this.el.content, t === 2 || t === 3) {
      const b = this.el.content.firstChild;
      b.replaceWith(...b.childNodes);
    }
    for (; (o = E.nextNode()) !== null && a.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const b of o.getAttributeNames()) if (b.endsWith(Fe)) {
          const g = f[s++], y = o.getAttribute(b).split(v), J = /([.?@])?(.*)/.exec(g);
          a.push({ type: 1, index: r, name: J[2], strings: y, ctor: J[1] === "." ? Ve : J[1] === "?" ? Ne : J[1] === "@" ? Ke : L }), o.removeAttribute(b);
        } else b.startsWith(v) && (a.push({ type: 6, index: r }), o.removeAttribute(b));
        if (Oe.test(o.tagName)) {
          const b = o.textContent.split(v), g = b.length - 1;
          if (g > 0) {
            o.textContent = Z ? Z.emptyScript : "";
            for (let y = 0; y < g; y++) o.append(b[y], j()), E.nextNode(), a.push({ type: 2, index: ++r });
            o.append(b[g], j());
          }
        }
      } else if (o.nodeType === 8) if (o.data === Ye) a.push({ type: 2, index: r });
      else {
        let b = -1;
        for (; (b = o.data.indexOf(v, b + 1)) !== -1; ) a.push({ type: 7, index: r }), b += v.length - 1;
      }
      r++;
    }
  }
...
function O(n, e, t = n, i) {
  ...
  return (o == null ? void 0 : o.constructor) !== r && ((c = o == null ? void 0 : o._$AO) == null || c.call(o, !1), r === void 0 ? o = void 0 : (o = new r(n), o._$AT(n, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = o : t._$Cl = o), o !== void 0 && (e = O(n, o._$AS(n, e.values), o, i)), e;
}
class Re {
  constructor(e, t) {
  ...
  u(e) {
    ...
    E.currentNode = o;
    let r = E.nextNode(), s = 0, c = 0, a = i[0];
    for (; a !== void 0; ) {
      if (s === a.index) {
        let l;
        a.type === 2 ? l = new G(r, r.nextSibling, this, e) : a.type === 1 ? l = new a.ctor(r, a.name, a.strings, this, e) : a.type === 6 && (l = new qe(r, this, e)), this._$AV.push(l), a = i[++c];
      }
      s !== (a == null ? void 0 : a.index) && (r = E.nextNode(), s++);
    }
...
class G {
  ...
  _$AI(e, t = this) {
    e = O(this, e, t), z(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== Y && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Te(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var r;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = B.createElement(Pe(i.h, i.h[0]), this.options)), i);
...
class L {
  ...
  _$AI(e, t = this, i, o) {
    ...
    let s = !1;
    if (r === void 0) e = O(this, e, t, 0), s = !z(e) || e !== this._$AH && e !== Y, s && (this._$AH = e);
    else {
      const c = e;
      let a, l;
      for (e = r[0], a = 0; a < r.length - 1; a++) l = O(this, c[i + a], t, a), l === Y && (l = this._$AH[a]), s || (s = !z(l) || l !== this._$AH[a]), l === h ? e = h : e !== h && (e += (l ?? "") + r[a + 1]), this._$AH[a] = l;
    }
    s && !o && this.j(e);
  }
  j(e) {
...
const N = Q.litHtmlPolyfillSupport;
N == null || N(B, G), (Q.litHtmlVersions ?? (Q.litHtmlVersions = [])).push("3.3.2");
const _e = (n, e, t) => {
...
var Ce;
F._$litElement$ = !0, F.finalized = !0, (Ce = M.litElementHydrateSupport) == null || Ce.call(M, { LitElement: F });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $e = { attribute: !0, type: String, converter: T, reflect: !1, hasChanged: re }, et = (n = $e, e, t) => {
...
`, q = ke(`'${Qe}'`), it = W`
  ...
  .swim-icon__i.swim-icon {
    ...
    width: 1em;
    height: 1em;
    font: normal normal normal 1em/1 ${q};
  ...
  ${tt}
`, ie = "data-swim-ui-icon-font-face";
let _ = !1;
function ot() {
  if (typeof document > "u" || document.head.querySelector(`style[${ie}]`)) return;
  ...
  e.setAttribute(ie, ""), e.textContent = `@font-face{font-family:'${Qe}';src:url('${n}') format('woff2');font-weight:normal;font-style:normal;font-display:block;}`, document.head.appendChild(e);
}
function nt() {
  typeof document > "u" || document.head.querySelector(`style[${ie}]`) || _ || (_ = !0, queueMicrotask(() => {
    _ = !1, ot();
  }));
}
const st = (n) => `swim-icon ${n.trim().split(" ").map((t) => {
  const [i, o] = t.split(":");
...
const ct = new rt();
var at = Object.defineProperty, X = (n, e, t, i) => {
  for (var o = void 0, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = s(e, t, o) || o);
  return o && at(e, t, o), o;
};
nt();
const Ae = "swim-icon", ae = class ae extends F {
  constructor() {
...
`, bt = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], ft = ["S", "M", "T", "W", "T", "F", "S"];
function oe(n, e) {
...
function m(n) {
  const e = /* @__PURE__ */ new Date(), t = n.getFullYear(), i = n.getMonth(), o = xe(t, i), r = new Date(t, i, 1).getDay(), s = [];
  if (r > 0) {
    const l = xe(t, i - 1);
    for (let f = r - 1; f >= 0; f--) {
      const b = new Date(t, i - 1, l - f);
      s.push($(b, i, e));
    }
  }
  for (let l = 1; l <= o; l++)
    s.push($(new Date(t, i, l), i, e));
  const c = s.length % 7;
  if (c > 0) {
    const l = 7 - c;
    for (let f = 1; f <= l; f++)
      s.push($(new Date(t, i + 1, f), i, e));
  }
  const a = [];
...
var ut = Object.defineProperty, mt = Object.getOwnPropertyDescriptor, p = (n, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? mt(e, t) : e, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = (i ? s(e, t, o) : s(o)) || o);
  return i && o && ut(e, t, o), o;
};
const Me = "swim-calendar", le = class le extends F {
  constructor() {
  ...
  updated(e) {
    super.updated(e), e.has("value") && this._value && (this._focusDate = new Date(this._value), this._weeks = m(this._focusDate), this._startYear = De(this._focusDate.getFullYear()));
  }
  // ---------------------------------------------------------------------------
  // Public methods
  // ---------------------------------------------------------------------------
  ...
  _renderDateView() {
    ...
    return d`
      <div class="text-center">
        ...
        <div class="day-name-row">${ft.map((t) => d`<div class="day-name text-center">${t}</div>`)}</div>
      ...
      (t) => d`
        ...
        const o = this._value ? oe(i.date, this._value) : !1, r = oe(i.date, this._focusDate), s = this.disabled || this._isDayDisabled(i.date), c = ["day"];
      ...
      <div class="text-center">
        ...
        <table class="months-container" role="grid">
          <tr class="months-row" role="row">
            ${bt.map((t, i) => {
      const o = this._isMonthActive(i), r = this._isCurrentMonth(i), s = this._focusDate.getMonth() === i && ht(this._focusDate, this._focusDate), c = this.disabled || this._isMonthDisabled(i), a = ["month"];
  ...
  // ---------------------------------------------------------------------------
  _init() {
    this._value && (this._focusDate = new Date(this._value)), this._weeks = m(this._focusDate), this._currentDate = /* @__PURE__ */ new Date(), this._startYear = De(this._focusDate.getFullYear()), this._validateView();
  }
  _validateView() {
    [
      "date",
  ...
  _resolveMin() {
    return this.minDate ? this.minDate instanceof Date ? this.minDate : Ee(this.minDate) : null;
  }
  _resolveMax() {
    return this.maxDate ? this.maxDate instanceof Date ? this.maxDate : Ee(this.maxDate) : null;
  }
  _isDayDisabled(e) {
    return ee(e, this._resolveMin(), "day") || te(e, this._resolveMax(), "day");
  }
  _isMonthDisabled(e) {
    const t = new Date(this._focusDate.getFullYear(), e, 1);
    return ee(t, this._resolveMin(), "month") || te(t, this._resolveMax(), "month");
  }
  _isYearDisabled(e) {
    const t = new Date(e, 0, 1);
    return ee(t, this._resolveMin(), "year") || te(t, this._resolveMax(), "year");
  }
  _isMonthActive(e) {
...
p([
  w({ type: Boolean, reflect: !0, converter: dt })
...
customElements.get(Me) || customElements.define(Me, u);
export {
  ft as DAYS_OF_WEEK,
  bt as MONTHS_SHORT,
  u as SwimCalendar,
  De as getDecadeStartYear,
  m as getMonth,
  te as isAfterDate,
  ee as isBeforeDate,
  oe as isSameDay,
