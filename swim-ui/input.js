 ...
 */
const J = globalThis, ne = J.ShadowRoot && (J.ShadyCSS === void 0 || J.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, se = Symbol(), ce = /* @__PURE__ */ new WeakMap();
let Se = class {
  constructor(e, t, i) {
...
const Ce = (o) => new Se(typeof o == "string" ? o : o + "", void 0, se), j = (o, ...e) => {
  const t = o.length === 1 ? o[0] : e.reduce((i, n, s) => i + ((r) => {
    if (r._$cssResult$ === !0) return r.cssText;
    if (typeof r == "number") return r;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + r + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(n) + o[s + 1], o[0]);
  return new Se(t, o, se);
}, je = (o, e) => {
  if (ne) o.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
...
}, be = ne ? (o) => o : (o) => o instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Te, defineProperty: De, getOwnPropertyDescriptor: Ie, getOwnPropertyNames: Fe, getOwnPropertySymbols: Ge, getPrototypeOf: We } = Object, E = globalThis, de = E.trustedTypes, Xe = de ? de.emptyScript : "", K = E.reactiveElementPolyfillSupport, F = (o, e) => o, Y = { toAttribute(o, e) {
  switch (e) {
    case Boolean:
      o = o ? Xe : null;
      break;
  ...
  return t;
} }, re = (o, e) => !Te(o, e), fe = { attribute: !0, type: String, converter: Y, reflect: !1, useDefault: !1, hasChanged: re };
...
let B = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(F("properties"))) {
      const t = this.properties, i = [...Fe(t), ...Ge(t)];
  ...
  _$ET(e, t) {
    ...
    if (n !== void 0 && i.reflect === !0) {
      const r = (((s = i.converter) == null ? void 0 : s.toAttribute) !== void 0 ? i.converter : Y).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (n !== void 0 && this._$Em !== n) {
      const a = i.getPropertyOptions(n), l = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((s = a.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? a.converter : Y;
      this._$Em = n;
  ...
  requestUpdate(e, t, i, n = !1, s) {
    ...
    if (e !== void 0) {
      ...
      if (n === !1 && (s = this[e]), i ?? (i = a.getPropertyOptions(e)), !((i.hasChanged ?? re)(s, t) || i.useDefault && i.reflect && s === ((r = this._$Ej) == null ? void 0 : r.get(e)) && !this.hasAttribute(a._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
...
B.elementStyles = [], B.shadowRootOptions = { mode: "open" }, B[F("elementProperties")] = /* @__PURE__ */ new Map(), B[F("finalized")] = /* @__PURE__ */ new Map(), K == null || K({ ReactiveElement: B }), (E.reactiveElementVersions ?? (E.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const Le = (o, e) => {
  ...
  return [ze(o, s + (o[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class R {
...
function Q(o, e, t = o, i) {
  ...
  return (n == null ? void 0 : n.constructor) !== s && ((a = n == null ? void 0 : n._$AO) == null || a.call(n, !1), s === void 0 ? n = void 0 : (n = new s(o), n._$AT(o, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = n : t._$Cl = n), n !== void 0 && (e = Q(o, n._$AS(o, e.values), n, i)), e;
}
class Je {
  constructor(e, t) {
...
class U {
  ...
  _$AI(e, t = this) {
    e = Q(this, e, t), X(e) ? e === f || e == null || e === "" ? (this._$AH !== f && this._$AR(), this._$AH = f) : e !== this._$AH && e !== w && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Ue(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== f && X(this._$AH) ? this._$AA.nextSibling.data = e : this.T(z.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    const { values: t, _$litType$: i } = e, n = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = R.createElement(ze(i.h, i.h[0]), this.options)), i);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let i, n = 0;
    for (const s of e) n === t.length ? t.push(i = new U(this.O(W()), this.O(W()), this, this.options)) : i = t[n], i._$AI(s), n++;
    n < t.length && (this._$AR(i && i._$AB.nextSibling, n), t.length = n);
  }
  _$AR(e = this._$AA.nextSibling, t) {
    var i;
    for ((i = this._$AP) == null ? void 0 : i.call(this, !1, !0, t); e !== this._$AB; ) {
      const n = he(e).nextSibling;
      he(e).remove(), e = n;
    }
  }
  setConnected(e) {
...
class V {
  ...
  constructor(e, t, i, n, s) {
    this.type = 1, this._$AH = f, this._$AN = void 0, this.element = e, this.name = t, this._$AM = n, this.options = s, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = f;
  }
  _$AI(e, t = this, i, n) {
    const s = this.strings;
    let r = !1;
    if (s === void 0) e = Q(this, e, t, 0), r = !X(e) || e !== this._$AH && e !== w, r && (this._$AH = e);
    else {
      const a = e;
      let l, p;
      for (e = s[0], l = 0; l < s.length - 1; l++) p = Q(this, a[i + l], t, l), p === w && (p = this._$AH[l]), r || (r = !X(p) || p !== this._$AH[l]), p === f ? e = f : e !== f && (e += (p ?? "") + s[l + 1]), this._$AH[l] = p;
    }
    r && !n && this.j(e);
  }
  j(e) {
...
class Ne extends V {
  ...
  _$AI(e, t = this) {
    if ((e = Q(this, e, t, 0) ?? f) === w) return;
    const i = this._$AH, n = e === f && i !== f || e.capture !== i.capture || e.once !== i.once || e.passive !== i.passive, s = e !== f && (i === f || n);
...
$ == null || $(R, U), (G.litHtmlVersions ?? (G.litHtmlVersions = [])).push("3.3.2");
const Ke = (o, e, t) => {
  const i = (t == null ? void 0 : t.renderBefore) ?? e;
  let n = i._$litPart$;
  if (n === void 0) {
    const s = (t == null ? void 0 : t.renderBefore) ?? null;
    i._$litPart$ = n = new U(e.insertBefore(W(), s), s, void 0, t ?? {});
  }
  return n._$AI(o), n;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const _e = { attribute: !0, type: String, converter: Y, reflect: !1, hasChanged: re }, $e = (o = _e, e, t) => {
...
function d(o) {
  return (e, t) => typeof t == "object" ? $e(o, e, t) : ((i, n, s) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const P = { ATTRIBUTE: 1, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4 }, it = (o) => (...e) => ({ _$litDirective$: o, values: e });
class ot {
  constructor(e) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const nt = (o) => o.strings === void 0, st = {}, rt = (o, e = st) => o._$AH = e;
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ye = it(class extends ot {
  constructor(o) {
    if (super(o), o.type !== P.PROPERTY && o.type !== P.ATTRIBUTE && o.type !== P.BOOLEAN_ATTRIBUTE) throw Error("The `live` directive is not allowed on child or event bindings");
    if (!nt(o)) throw Error("`live` bindings can only contain a single expression");
  }
  render(o) {
    return o;
  }
  update(o, [e]) {
    ...
    if (o.type === P.PROPERTY) {
      if (e === t[i]) return w;
    } else if (o.type === P.BOOLEAN_ATTRIBUTE) {
      if (!!e === t.hasAttribute(i)) return w;
    } else if (o.type === P.ATTRIBUTE && t.getAttribute(i) === e + "") return w;
    return rt(o), e;
  }
});
/**
...
`, te = Ce(`'${Be}'`), at = j`
  ...
  .swim-icon__i.swim-icon {
    ...
    width: 1em;
    height: 1em;
    font: normal normal normal 1em/1 ${te};
  ...
  ${lt}
`, oe = "data-swim-ui-icon-font-face";
let ie = !1;
function ct() {
  if (typeof document > "u" || document.head.querySelector(`style[${oe}]`)) return;
  ...
  e.setAttribute(oe, ""), e.textContent = `@font-face{font-family:'${Be}';src:url('${o}') format('woff2');font-weight:normal;font-style:normal;font-display:block;}`, document.head.appendChild(e);
}
function bt() {
  typeof document > "u" || document.head.querySelector(`style[${oe}]`) || ie || (ie = !0, queueMicrotask(() => {
    ie = !1, ct();
  }));
}
const dt = (o) => `swim-icon ${o.trim().split(" ").map((t) => {
  const [i, n] = t.split(":");
...
class ft {
  ...
  get(e, t) {
    return this.lookup(e, t).map((i) => dt(i));
  }
  lookup(e, t) {
...
const ht = new ft();
var pt = Object.defineProperty, Z = (o, e, t, i) => {
  for (var n = void 0, s = o.length - 1, r; s >= 0; s--)
    (r = o[s]) && (n = r(e, t, n) || n);
  return n && pt(e, t, n), n;
};
bt();
const xe = "swim-icon", ae = class ae extends H {
  constructor() {
  ...
  _updateFontIcon() {
    ...
    this._cssClasses = ht.get(e, this.fontSet);
  }
  render() {
    var s;
...
`;
var v = /* @__PURE__ */ ((o) => (o.text = "text", o.password = "password", o.email = "email", o.number = "number", o.tel = "tel", o.url = "url", o.textarea = "textarea", o))(v || {}), He = /* @__PURE__ */ ((o) => (o.legacy = "legacy", o.fill = "fill", o))(He || {}), Qe = /* @__PURE__ */ ((o) => (o.sm = "sm", o.md = "md", o.lg = "lg", o))(Qe || {});
function k(o) {
...
var gt = Object.defineProperty, vt = Object.getOwnPropertyDescriptor, b = (o, e, t, i) => {
  for (var n = i > 1 ? void 0 : i ? vt(e, t) : e, s = o.length - 1, r; s >= 0; s--)
    (r = o[s]) && (n = (i ? r(e, t, n) : r(n)) || n);
  return i && n && gt(e, t, n), n;
};
const Ae = "swim-input", N = class N extends H {
  constructor() {
    super(), this.type = v.text, this.label = "", this.placeholder = "", this.hint = "", this._value = "", this.name = "", this.id = `swim-input-${Math.random().toString(36).substr(2, 9)}`, this._disabled = !1, this._readonly = !1, this._required = !1, this._autofocus = !1, this.autocomplete = "off", this.appearance = He.legacy, this.size = Qe.sm, this._withMargin = !0, this._withHint = !0, this._passwordToggleEnabled = !1, this.textareaRows = 3, this.requiredIndicator = "*", this._focused = !1, this._passwordVisible = !1, this._touched = !1, this._dirty = !1, this._invalid = !1, this._internals = this.attachInternals();
  }
  get value() {
    return this._value;
  }
  ...
  render() {
    const e = this.type === v.textarea, t = this.type === v.password && this.passwordToggleEnabled && !this.disabled, i = this.type === v.number && !this.disabled, n = this._passwordVisible ? v.text : this.type;
    return u`
        ...
        <div class="input-flex-wrap">
          ...
          <div class="input-flex-wrap-inner">
            ...
            <label class="input-label" part="label" for="${this.id}">
              ${this.label} ${this.required ? u`<span>${this.requiredIndicator}</span>` : f}
            </label>
          </div>
  ...
  _increment() {
    if (this.inputElement && this.type === v.number) {
  ...
  _validate() {
    let e = !0;
    if (this.required && !this.value && (e = !1), this.type === v.number && this.value) {
...
N.styles = [Pe, mt, ut], N.formAssociated = !0;
let c = N;
b([
  tt(".input-box, .input-textarea")
...
b([
  d({ type: Boolean, reflect: !0, converter: D })
...
b([
  d({ type: Boolean, reflect: !0, attribute: "marginless", converter: D })
], c.prototype, "marginless", 1);
b([
  d({ type: Boolean, converter: wt })
], c.prototype, "withHint", 1);
b([
  d({ type: Boolean, attribute: "password-toggle-enabled", converter: D })
