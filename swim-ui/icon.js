 ...
 */
const X = globalThis, q = X.ShadowRoot && (X.ShadyCSS === void 0 || X.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, K = Symbol(), ee = /* @__PURE__ */ new WeakMap();
let de = class {
  constructor(e, t, i) {
...
const we = (n) => new de(typeof n == "string" ? n : n + "", void 0, K), F = (n, ...e) => {
...
}, te = q ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: xe, defineProperty: ve, getOwnPropertyDescriptor: Ee, getOwnPropertyNames: Se, getOwnPropertySymbols: Ce, getPrototypeOf: Me } = Object, p = globalThis, ie = p.trustedTypes, Oe = ie ? ie.emptyScript : "", k = p.reactiveElementPolyfillSupport, M = (n, e) => n, I = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Oe : null;
      break;
  ...
  return t;
} }, V = (n, e) => !xe(n, e), oe = { attribute: !0, type: String, converter: I, reflect: !1, useDefault: !1, hasChanged: V };
...
let v = class extends HTMLElement {
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const o of i) t.unshift(te(o));
  ...
  _$ET(e, t) {
    ...
    if (o !== void 0 && i.reflect === !0) {
      const r = (((s = i.converter) == null ? void 0 : s.toAttribute) !== void 0 ? i.converter : I).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const l = i.getPropertyOptions(o), c = typeof l.converter == "function" ? { fromAttribute: l.converter } : ((s = l.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? l.converter : I;
      this._$Em = o;
  ...
  requestUpdate(e, t, i, o = !1, s) {
    ...
    if (e !== void 0) {
      ...
      if (o === !1 && (s = this[e]), i ?? (i = l.getPropertyOptions(e)), !((i.hasChanged ?? V)(s, t) || i.useDefault && i.reflect && s === ((r = this._$Ej) == null ? void 0 : r.get(e)) && !this.hasAttribute(l._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
...
v.elementStyles = [], v.shadowRootOptions = { mode: "open" }, v[M("elementProperties")] = /* @__PURE__ */ new Map(), v[M("finalized")] = /* @__PURE__ */ new Map(), k == null || k({ ReactiveElement: v }), (p.reactiveElementVersions ?? (p.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const O = globalThis, ne = (n) => n, Z = O.trustedTypes, se = Z ? Z.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, he = "$lit$", h = `lit$${Math.random().toFixed(9).slice(2)}$`, pe = "?" + h, Qe = `<${pe}>`, x = document, P = () => x.createComment(""), H = (n) => n === null || typeof n != "object" && typeof n != "function", $ = Array.isArray, Pe = (n) => $(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", L = `[ 	
\f\r]`, C = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, re = /-->/g, ce = />/g, g = RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), le = /'/g, ae = /"/g, ue = /^(?:script|style|textarea|title)$/i, He = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), W = He(1), E = Symbol.for("lit-noChange"), f = Symbol.for("lit-nothing"), be = /* @__PURE__ */ new WeakMap(), A = x.createTreeWalker(x, 129);
function ge(n, e) {
...
const je = (n, e) => {
  ...
  let o, s = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", r = C;
  for (let l = 0; l < t; l++) {
    const c = n[l];
    let b, m, a = -1, d = 0;
    for (; d < c.length && (r.lastIndex = d, m = r.exec(c), m !== null); ) d = r.lastIndex, r === C ? m[1] === "!--" ? r = re : m[1] !== void 0 ? r = ce : m[2] !== void 0 ? (ue.test(m[2]) && (o = RegExp("</" + m[2], "g")), r = g) : m[3] !== void 0 && (r = g) : r === g ? m[0] === ">" ? (r = o ?? C, a = -1) : m[1] === void 0 ? a = -2 : (a = r.lastIndex - m[2].length, b = m[1], r = m[3] === void 0 ? g : m[3] === '"' ? ae : le) : r === ae || r === le ? r = g : r === re || r === ce ? r = C : (r = g, o = void 0);
    const w = r === g && n[l + 1].startsWith("/>") ? " " : "";
    s += r === C ? c + Qe : a >= 0 ? (i.push(b), c.slice(0, a) + he + c.slice(a) + h + w) : c + h + (a === -2 ? l : w);
  }
...
class j {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let s = 0, r = 0;
    const l = e.length - 1, c = this.parts, [b, m] = je(e, t);
    if (this.el = j.createElement(b, i), A.currentNode = this.el.content, t === 2 || t === 3) {
      const a = this.el.content.firstChild;
      a.replaceWith(...a.childNodes);
    }
    for (; (o = A.nextNode()) !== null && c.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const a of o.getAttributeNames()) if (a.endsWith(he)) {
          const d = m[r++], w = o.getAttribute(a).split(h), G = /([.?@])?(.*)/.exec(d);
          c.push({ type: 1, index: s, name: G[2], strings: w, ctor: G[1] === "." ? ze : G[1] === "?" ? De : G[1] === "@" ? Ge : J }), o.removeAttribute(a);
        } else a.startsWith(h) && (c.push({ type: 6, index: s }), o.removeAttribute(a));
        if (ue.test(o.tagName)) {
          const a = o.textContent.split(h), d = a.length - 1;
          if (d > 0) {
            o.textContent = Z ? Z.emptyScript : "";
            for (let w = 0; w < d; w++) o.append(a[w], P()), A.nextNode(), c.push({ type: 2, index: ++s });
            o.append(a[d], P());
          }
        }
      } else if (o.nodeType === 8) if (o.data === pe) c.push({ type: 2, index: s });
      else {
        let a = -1;
        for (; (a = o.data.indexOf(h, a + 1)) !== -1; ) c.push({ type: 7, index: s }), a += h.length - 1;
      }
      s++;
    }
  }
...
function S(n, e, t = n, i) {
  ...
  return (o == null ? void 0 : o.constructor) !== s && ((l = o == null ? void 0 : o._$AO) == null || l.call(o, !1), s === void 0 ? o = void 0 : (o = new s(n), o._$AT(n, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = o : t._$Cl = o), o !== void 0 && (e = S(n, o._$AS(n, e.values), o, i)), e;
}
class Be {
  constructor(e, t) {
  ...
  u(e) {
    ...
    A.currentNode = o;
    let s = A.nextNode(), r = 0, l = 0, c = i[0];
    for (; c !== void 0; ) {
      if (r === c.index) {
        let b;
        c.type === 2 ? b = new B(s, s.nextSibling, this, e) : c.type === 1 ? b = new c.ctor(s, c.name, c.strings, this, e) : c.type === 6 && (b = new We(s, this, e)), this._$AV.push(b), c = i[++l];
      }
...
class B {
  ...
  _$AI(e, t = this) {
    e = S(this, e, t), H(e) ? e === f || e == null || e === "" ? (this._$AH !== f && this._$AR(), this._$AH = f) : e !== this._$AH && e !== E && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Pe(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== f && H(this._$AH) ? this._$AA.nextSibling.data = e : this.T(x.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    ...
    if (((s = this._$AH) == null ? void 0 : s._$AD) === o) this._$AH.p(t);
      ...
      const r = new Be(o, this), l = r.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let i, o = 0;
    for (const s of e) o === t.length ? t.push(i = new B(this.O(P()), this.O(P()), this, this.options)) : i = t[o], i._$AI(s), o++;
...
class J {
  ...
  constructor(e, t, i, o, s) {
    this.type = 1, this._$AH = f, this._$AN = void 0, this.element = e, this.name = t, this._$AM = o, this.options = s, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = f;
  }
  _$AI(e, t = this, i, o) {
    const s = this.strings;
    let r = !1;
    if (s === void 0) e = S(this, e, t, 0), r = !H(e) || e !== this._$AH && e !== E, r && (this._$AH = e);
    else {
      const l = e;
      let c, b;
      for (e = s[0], c = 0; c < s.length - 1; c++) b = S(this, l[i + c], t, c), b === E && (b = this._$AH[c]), r || (r = !H(b) || b !== this._$AH[c]), b === f ? e = f : e !== f && (e += (b ?? "") + s[c + 1]), this._$AH[c] = b;
    }
    r && !o && this.j(e);
  }
  j(e) {
...
const Y = O.litHtmlPolyfillSupport;
Y == null || Y(j, B), (O.litHtmlVersions ?? (O.litHtmlVersions = [])).push("3.3.2");
const Xe = (n, e, t) => {
  const i = (t == null ? void 0 : t.renderBefore) ?? e;
  let o = i._$litPart$;
  if (o === void 0) {
    const s = (t == null ? void 0 : t.renderBefore) ?? null;
    i._$litPart$ = o = new B(e.insertBefore(P(), s), s, void 0, t ?? {});
  }
  return o._$AI(n), o;
};
/**
...
var me;
Q._$litElement$ = !0, Q.finalized = !0, (me = y.litElementHydrateSupport) == null || me.call(y, { LitElement: Q });
const U = y.litElementPolyfillSupport;
U == null || U({ LitElement: Q });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ie = { attribute: !0, type: String, converter: I, reflect: !1, hasChanged: V }, Ze = (n = Ie, e, t) => {
...
`, R = we(`'${Ae}'`), Le = F`
  ...
  .swim-icon__i.swim-icon {
    ...
    width: 1em;
    height: 1em;
    font: normal normal normal 1em/1 ${R};
  ...
  ${ke}
`, N = "data-swim-ui-icon-font-face";
let T = !1;
function Ye() {
  if (typeof document > "u" || document.head.querySelector(`style[${N}]`)) return;
  ...
  e.setAttribute(N, ""), e.textContent = `@font-face{font-family:'${Ae}';src:url('${n}') format('woff2');font-weight:normal;font-style:normal;font-display:block;}`, document.head.appendChild(e);
}
function Ue() {
  typeof document > "u" || document.head.querySelector(`style[${N}]`) || T || (T = !0, queueMicrotask(() => {
    T = !1, Ye();
  }));
}
const Re = (n) => `swim-icon ${n.trim().split(" ").map((t) => {
  const [i, o] = t.split(":");
...
class Te {
  ...
  get(e, t) {
    return this.lookup(e, t).map((i) => Re(i));
  }
  lookup(e, t) {
...
const Ne = new Te();
var qe = Object.defineProperty, D = (n, e, t, i) => {
  for (var o = void 0, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (o = r(e, t, o) || o);
  return o && qe(e, t, o), o;
};
Ue();
const fe = "swim-icon", _ = class _ extends Q {
  constructor() {
  ...
  _updateFontIcon() {
    ...
    this._cssClasses = Ne.get(e, this.fontSet);
  }
  render() {
    var s;
    ...
    return !e || e.length === 0 ? W`
      ...
      >
        ${e.map(
      (r, l) => W`<i part="icon icon-${l}" class="swim-icon__i swim-icon__i--${l} ${r}${o}"></i>`
    )}
      </span>
    `;
  }
...
let u = _;
D([
  z({ type: String, attribute: "font-icon" })
], u.prototype, "fontIcon");
D([
  z({ type: String })
], u.prototype, "alt");
D([
  z({ type: String, attribute: "font-set" })
], u.prototype, "fontSet");
D([
  z({ type: String, attribute: "icon-class" })
], u.prototype, "iconClass");
D([
  Fe()
], u.prototype, "_cssClasses");
customElements.get(fe) || customElements.define(fe, u);
export {
  Ae as SWIM_ICON_FONT_FAMILY,
  u as SwimIcon,
  Ye as ensureSwimUiIconFontFace,
  Ue as scheduleEnsureSwimUiIconFontFace
};
