 ...
 */
const T = globalThis, ee = T.ShadowRoot && (T.ShadyCSS === void 0 || T.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, te = Symbol(), re = /* @__PURE__ */ new WeakMap();
let ve = class {
  constructor(e, t, i) {
...
const ye = (n) => new ve(typeof n == "string" ? n : n + "", void 0, te), G = (n, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Me, defineProperty: Oe, getOwnPropertyDescriptor: Qe, getOwnPropertyNames: je, getOwnPropertySymbols: ze, getPrototypeOf: He } = Object, A = globalThis, ce = A.trustedTypes, Be = ce ? ce.emptyScript : "", Y = A.reactiveElementPolyfillSupport, z = (n, e) => n, Z = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Be : null;
      break;
  ...
  return t;
} }, ie = (n, e) => !Me(n, e), le = { attribute: !0, type: String, converter: Z, reflect: !1, useDefault: !1, hasChanged: ie };
...
let P = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, i) {
    const { get: o, set: r } = Qe(this.prototype, e) ?? { get() {
      return this[t];
    }, set(s) {
      this[t] = s;
    } };
  ...
  _$ET(e, t) {
    ...
    if (o !== void 0 && i.reflect === !0) {
      const s = (((r = i.converter) == null ? void 0 : r.toAttribute) !== void 0 ? i.converter : Z).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const l = i.getPropertyOptions(o), c = typeof l.converter == "function" ? { fromAttribute: l.converter } : ((r = l.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? l.converter : Z;
      this._$Em = o;
  ...
  requestUpdate(e, t, i, o = !1, r) {
    ...
    if (e !== void 0) {
      ...
      if (o === !1 && (r = this[e]), i ?? (i = l.getPropertyOptions(e)), !((i.hasChanged ?? ie)(r, t) || i.useDefault && i.reflect && r === ((s = this._$Ej) == null ? void 0 : s.get(e)) && !this.hasAttribute(l._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
...
P.elementStyles = [], P.shadowRootOptions = { mode: "open" }, P[z("elementProperties")] = /* @__PURE__ */ new Map(), P[z("finalized")] = /* @__PURE__ */ new Map(), Y == null || Y({ ReactiveElement: P }), (A.reactiveElementVersions ?? (A.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const H = globalThis, ae = (n) => n, L = H.trustedTypes, be = L ? L.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, Ae = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, xe = "?" + y, De = `<${xe}>`, k = document, B = () => k.createComment(""), D = (n) => n === null || typeof n != "object" && typeof n != "function", oe = Array.isArray, Ie = (n) => oe(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", N = `[ 	
\f\r]`, j = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, fe = /-->/g, me = />/g, S = RegExp(`>|${N}(?:([^\\s"'>=/]+)(${N}*=${N}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), de = /'/g, he = /"/g, Se = /^(?:script|style|textarea|title)$/i, Ge = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), g = Ge(1), O = Symbol.for("lit-noChange"), b = Symbol.for("lit-nothing"), we = /* @__PURE__ */ new WeakMap(), E = k.createTreeWalker(k, 129);
function Ee(n, e) {
...
const We = (n, e) => {
  ...
  let o, r = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", s = j;
  for (let l = 0; l < t; l++) {
    const c = n[l];
    let f, m, a = -1, u = 0;
    for (; u < c.length && (s.lastIndex = u, m = s.exec(c), m !== null); ) u = s.lastIndex, s === j ? m[1] === "!--" ? s = fe : m[1] !== void 0 ? s = me : m[2] !== void 0 ? (Se.test(m[2]) && (o = RegExp("</" + m[2], "g")), s = S) : m[3] !== void 0 && (s = S) : s === S ? m[0] === ">" ? (s = o ?? j, a = -1) : m[1] === void 0 ? a = -2 : (a = s.lastIndex - m[2].length, f = m[1], s = m[3] === void 0 ? S : m[3] === '"' ? he : de) : s === he || s === de ? s = S : s === fe || s === me ? s = j : (s = S, o = void 0);
    const v = s === S && n[l + 1].startsWith("/>") ? " " : "";
    r += s === j ? c + De : a >= 0 ? (i.push(f), c.slice(0, a) + Ae + c.slice(a) + y + v) : c + y + (a === -2 ? l : v);
  }
...
class I {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let r = 0, s = 0;
    const l = e.length - 1, c = this.parts, [f, m] = We(e, t);
    if (this.el = I.createElement(f, i), E.currentNode = this.el.content, t === 2 || t === 3) {
      const a = this.el.content.firstChild;
      a.replaceWith(...a.childNodes);
    }
    for (; (o = E.nextNode()) !== null && c.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const a of o.getAttributeNames()) if (a.endsWith(Ae)) {
          const u = m[s++], v = o.getAttribute(a).split(y), F = /([.?@])?(.*)/.exec(u);
          c.push({ type: 1, index: r, name: F[2], strings: v, ctor: F[1] === "." ? Fe : F[1] === "?" ? Te : F[1] === "@" ? Ze : U }), o.removeAttribute(a);
        } else a.startsWith(y) && (c.push({ type: 6, index: r }), o.removeAttribute(a));
        if (Se.test(o.tagName)) {
          const a = o.textContent.split(y), u = a.length - 1;
          if (u > 0) {
            o.textContent = L ? L.emptyScript : "";
            for (let v = 0; v < u; v++) o.append(a[v], B()), E.nextNode(), c.push({ type: 2, index: ++r });
            o.append(a[u], B());
          }
        }
      } else if (o.nodeType === 8) if (o.data === xe) c.push({ type: 2, index: r });
      else {
        let a = -1;
...
function Q(n, e, t = n, i) {
  ...
  return (o == null ? void 0 : o.constructor) !== r && ((l = o == null ? void 0 : o._$AO) == null || l.call(o, !1), r === void 0 ? o = void 0 : (o = new r(n), o._$AT(n, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = o : t._$Cl = o), o !== void 0 && (e = Q(n, o._$AS(n, e.values), o, i)), e;
}
class Xe {
  constructor(e, t) {
  ...
  u(e) {
    ...
    E.currentNode = o;
    let r = E.nextNode(), s = 0, l = 0, c = i[0];
    for (; c !== void 0; ) {
      if (s === c.index) {
        let f;
        c.type === 2 ? f = new W(r, r.nextSibling, this, e) : c.type === 1 ? f = new c.ctor(r, c.name, c.strings, this, e) : c.type === 6 && (f = new Le(r, this, e)), this._$AV.push(f), c = i[++l];
      }
      s !== (c == null ? void 0 : c.index) && (r = E.nextNode(), s++);
    }
    return E.currentNode = k, o;
  }
  p(e) {
    let t = 0;
...
class W {
  ...
  _$AI(e, t = this) {
    e = Q(this, e, t), D(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== O && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Ie(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var r;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = I.createElement(Ee(i.h, i.h[0]), this.options)), i);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === o) this._$AH.p(t);
    else {
      const s = new Xe(o, this), l = s.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let i, o = 0;
    for (const r of e) o === t.length ? t.push(i = new W(this.O(B()), this.O(B()), this, this.options)) : i = t[o], i._$AI(r), o++;
...
class U {
  ...
  _$AI(e, t = this, i, o) {
    ...
    let s = !1;
    if (r === void 0) e = Q(this, e, t, 0), s = !D(e) || e !== this._$AH && e !== O, s && (this._$AH = e);
    else {
      const l = e;
      let c, f;
      for (e = r[0], c = 0; c < r.length - 1; c++) f = Q(this, l[i + c], t, c), f === O && (f = this._$AH[c]), s || (s = !D(f) || f !== this._$AH[c]), f === b ? e = b : e !== b && (e += (f ?? "") + r[c + 1]), this._$AH[c] = f;
    }
    s && !o && this.j(e);
  }
  j(e) {
...
q == null || q(I, W), (H.litHtmlVersions ?? (H.litHtmlVersions = [])).push("3.3.2");
const Je = (n, e, t) => {
  const i = (t == null ? void 0 : t.renderBefore) ?? e;
  let o = i._$litPart$;
  if (o === void 0) {
    const r = (t == null ? void 0 : t.renderBefore) ?? null;
    i._$litPart$ = o = new W(e.insertBefore(B(), r), r, void 0, t ?? {});
  }
  return o._$AI(n), o;
};
/**
...
var ge;
M._$litElement$ = !0, M.finalized = !0, (ge = C.litElementHydrateSupport) == null || ge.call(C, { LitElement: M });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ue = { attribute: !0, type: String, converter: Z, reflect: !1, hasChanged: ie }, Re = (n = Ue, e, t) => {
...
function h(n) {
  return (e, t) => typeof t == "object" ? Re(n, e, t) : ((i, o, r) => {
...
`, V = ye(`'${ke}'`), $e = G`
  ...
  .swim-icon__i.swim-icon {
    ...
    width: 1em;
    height: 1em;
    font: normal normal normal 1em/1 ${V};
  ...
  ${_e}
`, $ = "data-swim-ui-icon-font-face";
let _ = !1;
function et() {
  if (typeof document > "u" || document.head.querySelector(`style[${$}]`)) return;
  ...
  e.setAttribute($, ""), e.textContent = `@font-face{font-family:'${ke}';src:url('${n}') format('woff2');font-weight:normal;font-style:normal;font-display:block;}`, document.head.appendChild(e);
}
function tt() {
  typeof document > "u" || document.head.querySelector(`style[${$}]`) || _ || (_ = !0, queueMicrotask(() => {
    _ = !1, et();
  }));
}
const it = (n) => `swim-icon ${n.trim().split(" ").map((t) => {
  const [i, o] = t.split(":");
...
const nt = new ot();
var rt = Object.defineProperty, X = (n, e, t, i) => {
  for (var o = void 0, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = s(e, t, o) || o);
  return o && rt(e, t, o), o;
};
tt();
const pe = "swim-icon", ne = class ne extends M {
  constructor() {
...
var st = Object.defineProperty, ct = Object.getOwnPropertyDescriptor, w = (n, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? ct(e, t) : e, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = (i ? s(e, t, o) : s(o)) || o);
  return i && o && st(e, t, o), o;
};
const ue = "swim-button", J = class J extends M {
  constructor() {
...
J.styles = [Ce, Ye], J.formAssociated = !0;
let d = J;
w([
...
w([
  h({ type: Boolean, reflect: !0, converter: Ve })
...
w([
  h({ type: String, attribute: "loading-text" })
], d.prototype, "loadingText", 2);
w([
  h({ type: Boolean, reflect: !0, attribute: "wrap-text", converter: Ke })
], d.prototype, "wrapText", 2);
w([
  h({ attribute: !1 })
