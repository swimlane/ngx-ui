...
export class CalendarComponent implements OnInit {
  ...
  @Input('minView')
  set _minView(v: EnumKey<typeof CalendarView>) {
    this.minView = CalendarView[v];
    this.validateView();
  }

  minView = CalendarView.date;

  @Input('defaultView')
  set _defaultView(v: EnumKey<typeof CalendarView>) {
    this.defaultView = CalendarView[v];
    this.validateView();
  }

  defaultView = CalendarView.date;
  ...
  validateView() {
    ...
    if (viewsList.indexOf(this.minView) > viewsList.indexOf(this.defaultView)) {
      this._defaultView = Object.keys(CalendarView).find(
        (key) =>
