...
export class NotificationService extends InjectionRegistryService<NotificationComponent> {
  ...
  createSubscriptions(component: ComponentRef<NotificationComponent>): any {
    ...
    let resumeSub: Subscription | null = null;
    ...
    pauseSub = component.instance.notificationPause.subscribe(pause);
    resumeSub = component.instance.notificationResume.subscribe(resume);
    closeSub = component.instance.notificationClose.subscribe(kill);
  }
