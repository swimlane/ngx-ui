describe('Notifications', () => {
  ...
  it('should display and close an info notification', () => {
    ...
    cy.get('.ngx-notification.ngx-notification-info')
      .whileHovering(() => {
  ...
  it('should display a success notification', () => {
    ...
    cy.get('.ngx-notification.ngx-notification-success')
      .whileHovering(() => {
  ...
  it('should display a warning notification', () => {
    ...
    cy.get('.ngx-notification.ngx-notification-warning')
      .whileHovering(() => {
  ...
  it('should display a error notification', () => {
    ...
    cy.get('.ngx-notification.ngx-notification-error')
      .whileHovering(() => {
  ...
  it('should display a custom notification', () => {
    ...
    cy.get('.ngx-notification.ngx-notification-none').last()
      .whileHovering(() => {
        cy.get('.ngx-notification-body').should('contain.text', 'Patch Failed!');
        cy.get('.ngx-notification-close').click();
      });
